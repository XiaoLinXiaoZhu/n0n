...
export const showConfig: ShowTypeConfig[] = [
	{
		value: "working log",
		typeDesc:
			"内部工作日志。记录判断、证据、排除的替代方案。系统自动继续循环，用户不会被即时通知。如果需要用户现在看到并响应，使用其他三种 type。",
		contentDesc: "",
	},
	{
		value: "ask user question",
		typeDesc: "向用户提问，等待选择。系统暂停循环，等待用户响应。",
		contentDesc:
			"先展示推导上下文，再提供 2-4 个选项（每个选项以 `## ` 开头为标题行，下一行写说明）。必须自包含。",
	},
	{
		value: "request user assistance",
		typeDesc: "需要用户介入。系统暂停循环，等待用户响应。",
		contentDesc:
	...
	},
	{
		value: "final report",
		typeDesc:
			"任务完成，面向用户的正式交付。系统暂停循环，等待用户响应。详细说明已完成工作、验证结果、关键决策。假定用户已失去上下文，完整自包含。",
		contentDesc: "",
	},
];

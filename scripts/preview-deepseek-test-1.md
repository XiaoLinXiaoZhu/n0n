...
|------|-----|
| API Messages 总数 | 3 |
| 系统消息字符数 | 1,037 chars (~259 tokens) |
| 用户消息字符数 | 6,443 chars (~1,611 tokens) |
| 总字符数 | 7,480 chars (~1,870 tokens) |
...
### [1/3] role: `system` (1,037 chars, ~259 tokens)
...
### [2/3] role: `user` (6,414 chars, ~1,604 tokens)
...
| 系统消息大小 | 1,037 chars (~259 tokens) | 7,205 chars (~1,801 tokens) |
| 第一条 user 消息大小 | 6,443 chars (~1,611 tokens) | 29 chars (~7 tokens) |

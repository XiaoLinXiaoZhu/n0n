...
分类术语定义见 [skill-taxonomy.md](../skill-taxonomy.md)。

## [topic/](./topic/) — 主题讨论

围绕某个主题的分析和讨论，是 Standard 的基石。

- [coding-and-testing](./topic/coding-and-testing.md) — 编码实践与测试（coding 标准、AI TDD、变异测试）
- [interaction-protocol](./topic/interaction-protocol.md) — 交互协议（research/step/zoom-out/grill-me、badcase→规则设计法）
- [git-workflow](./topic/git-workflow.md) — Git 工作流（标准定位、默认开启）
...
| 分组 | 内容 |
|------|------|
| [bug-fix/](./task/bug-fix/) | [bugfix](./task/bug-fix/bugfix.md), [diagnose](./task/bug-fix/diagnose.md) |
...
- [ssh-remote](./cap/ssh-remote.md) — SSH 远程服务器操作
- [ppio-web-search](./cap/ppio-web-search.md) — PPIO 网页搜索
- [everything-cli](./cap/everything-cli.md) — Everything 文件搜索
- [annotation](./cap/annotation.md) — Markdown 批注读写
